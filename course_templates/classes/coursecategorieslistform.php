...
class coursecategorieslistform extends \moodleform {
    ...
    protected function definition() {
        ...
        global $CFG;
        $tooltip_url = $CFG->wwwroot.'/local/course_templates/pix/circle-grey-exclamenation.svg';
        $html = '<span class="tooltip-status">
                        <img src="' . $tooltip_url . '" alt="">
                        <div class="tooltiptext">
                            <div class="border-tooltip css-border-arrow top"></div>
                            Your new course would be saved here.
                        </div>
                    </span>';
        $mform->addElement(
                'autocomplete',
        ...
        $buttonarray[] = &$mform->createElement(
            ...
            get_string('next', 'local_course_templates')
        );
