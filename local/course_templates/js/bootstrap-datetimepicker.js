(
    function (factory) {
        ...
        setDatesDisabled: function (datesDisabled) {
            ...
            var mThis = this;
            this.datesDisabled = $.map(
            this.datesDisabled, function (d) {
        ...
        setDaysOfWeekDisabled: function (daysOfWeekDisabled) {
            ...
            this.daysOfWeekDisabled, function (d) {
        ...
        setMinutesDisabled: function (minutesDisabled) {
            ...
            this.minutesDisabled = $.map(
            this.minutesDisabled, function (d) {
                return parseInt(d, 10);
                }
            );
            this.update();
        ...
        setHoursDisabled: function (hoursDisabled) {
            ...
            this.hoursDisabled = $.map(
            this.hoursDisabled, function (d) {
                return parseInt(d, 10);
                }
            );
            this.update();
        ...
        place: function () {
            ...
            left = left - containerOffset.left + 280;
            this.picker.css(
            {
                top:    top,
                left:   left,
