...
$string['choosetemplatebanner'] = 'Choose existing course';
...
$string['createcoursefromtemplate'] = 'Create a duplicate course';
$string['datetime'] = 'Date and time';
$string['definesettingsbanner'] = 'Name of the new Course';
...
$string['selectcategorybanner'] = 'Select a Category';
$string['startdate'] = 'Start date';
$string['starttime'] = 'Start time';
$string['useastemplate'] = 'Create Duplicate';
$string['next'] = 'Next';
$string['categorey_moove_help'] = 'Your new course would be saved here';
