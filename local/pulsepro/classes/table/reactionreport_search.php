 ...
 **/
class reactionreport_search extends \core_user\table\participants_search {
    ...
    protected function get_participants_sql(string $additionalwhere, array $additionalparams): array {
        ...
        // JOIN the pulse notification result.
        $outerjoins[] = "LEFT JOIN {local_pulsepro_availability} ppa ON ppa.userid=u.id AND ppa.pulseid = pl.id";

        $outerselect .= ', '.$this->pulseavailability_fields();
